...
#define STRIP_LED_AMOUNT 256/3  // количество чипов WS2811/WS2812 на всех ступеньках. Для WS2811 кол-во чипов = кол-во светодиодов / 3
...
Step steps[STEP_AMOUNT] = {
  ...
  { 16, 0b0000000000000000 },   // 16
  { 16, 0b0100100100100100 }    // 17
};
